 ...
 useEffect(() => {
  ...
  <table className="w-full text-sm text-left border-collapse border border-gray-300">
    <thead className="bg-gray-200">
      <tr>
        <th className="px-4 py-2 border border-gray-300" colSpan="2">Minimum Charge</th>
        <th className="px-4 py-2 border border-gray-300">Minimum Km Covered</th>
        <th className="px-4 py-2 border border-gray-300">Per Km</th>
      </tr>
    </thead>
    <tbody>
